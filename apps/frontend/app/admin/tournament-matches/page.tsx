...
export default function TournamentMatchesPage() {
  ...
  const getCompletionTypeBadge = (match: Match) => {
    ...
    const badges = {
      normal: { 
        label: 'Won', 
        className: 'bg-green-500/10 dark:bg-green-500/10 text-green-600 dark:text-green-500 border-green-500/30', 
        icon: Trophy 
      },
      walkover: { 
        label: 'W/O', 
        className: 'bg-orange-500/10 dark:bg-orange-500/10 text-orange-600 dark:text-orange-500 border-orange-500/30', 
        icon: XCircle 
      },
      forfeit: { 
        label: 'Forfeit', 
        className: 'bg-red-500/10 dark:bg-red-500/10 text-red-600 dark:text-red-500 border-red-500/30', 
        icon: XCircle 
      },
      disqualification: { 
        label: 'DQ', 
        className: 'bg-red-600/10 dark:bg-red-600/10 text-red-700 dark:text-red-600 border-red-600/30', 
        icon: XCircle 
      },
      retired: { 
        label: 'Retired', 
        className: 'bg-yellow-600/10 dark:bg-yellow-600/10 text-yellow-700 dark:text-yellow-600 border-yellow-600/30', 
        icon: XCircle 
      },
      manual: { 
        label: 'Manual', 
        className: 'bg-blue-500/10 dark:bg-blue-500/10 text-blue-600 dark:text-blue-500 border-blue-500/30', 
        icon: Edit 
      },
    };
  ...
  const getStatusBadge = (status: string) => {
    const statusConfig = {
      scheduled: { color: 'bg-blue-500/10 dark:bg-blue-500/10 border-blue-500/30 text-blue-600 dark:text-blue-400', icon: Clock },
      in_progress: { color: 'bg-yellow-500/10 dark:bg-yellow-500/10 border-yellow-500/30 text-yellow-600 dark:text-yellow-400', icon: Zap },
      completed: { color: 'bg-green-500/10 dark:bg-green-500/10 border-green-500/30 text-green-600 dark:text-green-400', icon: CheckCircle },
      cancelled: { color: 'bg-red-500/10 dark:bg-red-500/10 border-red-500/30 text-red-600 dark:text-red-400', icon: XCircle },
    };
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
          <motion.div
            ...
            className="glass-card-intense rounded-2xl p-4 lg:p-6"
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 lg:w-12 lg:h-12 bg-blue-500/10 dark:bg-blue-500/10 rounded-xl flex items-center justify-center">
                <Trophy className="h-5 w-5 lg:h-6 lg:w-6 text-blue-500 dark:text-blue-400" />
              </div>
              <div>
                <p className="text-xs lg:text-sm text-tertiary">Total</p>
                <p className="text-xl lg:text-2xl font-bold text-primary">{stats.totalMatches}</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 lg:w-12 lg:h-12 bg-green-500/10 dark:bg-green-500/10 rounded-xl flex items-center justify-center">
                <CheckCircle className="h-5 w-5 lg:h-6 lg:w-6 text-green-600 dark:text-green-400" />
              </div>
              <div>
                <p className="text-xs lg:text-sm text-tertiary">Completed</p>
                <p className="text-xl lg:text-2xl font-bold text-primary">{stats.completedMatches}</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 lg:w-12 lg:h-12 bg-yellow-500/10 dark:bg-yellow-500/10 rounded-xl flex items-center justify-center">
                <Clock className="h-5 w-5 lg:h-6 lg:w-6 text-yellow-600 dark:text-yellow-400" />
              </div>
              <div>
                <p className="text-xs lg:text-sm text-tertiary">Avg Time</p>
                <p className="text-xl lg:text-2xl font-bold text-primary">{stats.averageDuration}m</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 lg:w-12 lg:h-12 bg-purple-500/10 dark:bg-purple-500/10 rounded-xl flex items-center justify-center">
                <Users className="h-5 w-5 lg:h-6 lg:w-6 text-purple-600 dark:text-purple-400" />
              </div>
              <div>
                <p className="text-xs lg:text-sm text-tertiary">Players</p>
                <p className="text-xl lg:text-2xl font-bold text-primary">{stats.totalPlayers}</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="space-y-3">
          {filteredMatches.length === 0 ? (
            <div className="glass-card-intense rounded-2xl p-12 text-center">
              <Trophy className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
              <p className="text-tertiary">No matches found</p>
            </div>
          ) : (
              ...
              return (
                ...
                >
                  <motion.div
                    ...
                    className="glass-card-intense rounded-2xl overflow-hidden hover:scale-[1.01] transition-all cursor-pointer"
                  >
                    {/* Match Header */}
                    <div className="px-4 lg:px-6 py-3 lg:py-4 border-b border-border bg-muted/30">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 lg:gap-4">
                        <div className="flex items-center gap-2 lg:gap-3 flex-wrap">
                          <span className="text-xs lg:text-sm font-semibold text-tertiary">
                            Match #{match.matchNumber}
                          </span>
                          <span className="text-xs lg:text-sm font-medium text-primary">
                            {getRoundName(match.roundNumber, totalRounds)}
                          </span>
                          <span className="text-xs lg:text-sm text-tertiary capitalize">
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <ChevronRight className="h-5 w-5 text-tertiary group-hover:text-blue-500 transition-colors ml-2" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-4 lg:p-6">
                      ...
                      <div className="space-y-3 mb-4">
                        ...
                        <div className={`flex items-center justify-between p-3 lg:p-4 rounded-xl border ${
                          isPlayer1Winner 
                            ? 'bg-green-500/10 dark:bg-green-500/10 border-green-500/30' 
                            : 'bg-muted/50 border-border'
                        }`}>
                          <div className="flex items-center gap-3 min-w-0 flex-1">
                            {isPlayer1Winner && <Trophy className="h-4 w-4 lg:h-5 lg:w-5 text-green-600 dark:text-green-400 flex-shrink-0" />}
                              ...
                              {match.player1Score.filter(s => s > 0).map((score, i) => (
                                <span 
                                  ...
                                  className={`text-sm lg:text-base font-bold px-2 py-1 rounded ${
                                    isPlayer1Winner ? 'text-green-600 dark:text-green-400' : 'text-tertiary'
                                  }`}
                                >
                                  {score}
                                </span>
                        ...
                        <div className={`flex items-center justify-between p-3 lg:p-4 rounded-xl border ${
                          ...
                          <div className="flex items-center gap-3 min-w-0 flex-1">
                            {isPlayer2Winner && <Trophy className="h-4 w-4 lg:h-5 lg:w-5 text-green-600 dark:text-green-400 flex-shrink-0" />}
                            <span className={`text-sm lg:text-base font-medium truncate ${
                              player2Display === 'TBD' 
                                ? 'text-muted-foreground italic' 
                                : isPlayer2Winner 
                            ...
                            <div className="flex gap-2 ml-3">
                              {match.player2Score.filter(s => s > 0).map((score, i) => (
                                <span 
                                  key={i} 
                                  className={`text-sm lg:text-base font-bold px-2 py-1 rounded ${
                                    isPlayer2Winner ? 'text-green-600 dark:text-green-400' : 'text-tertiary'
                                  }`}
                                >
                                  {score}
                                </span>
                      ...
                      {(match.scheduledDate || match.scheduledTime || match.venue || match.court || match.duration) && (
                        <div className="flex flex-wrap gap-3 lg:gap-4 text-xs lg:text-sm text-tertiary pt-3 border-t border-border">
                          {match.scheduledDate && (
        ...
        <div className="glass-card-intense rounded-2xl p-6">
          ...
          {playerStats.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-tertiary">No player statistics available yet</p>
            </div>
          ) : (
            <div className="space-y-4">
              {playerStats.map((stats, index) => (
                <motion.div
                  ...
                  className="glass-card-intense rounded-xl p-6 hover:scale-[1.01] transition-all"
                >
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-primary">{stats.playerName}</h4>
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                    ...
                    <div className="bg-muted/50 rounded-lg p-3">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-xs text-tertiary">Titles</span>
                      </div>
  ...
  if (isLoading) {
    return (
      <div className="relative z-10 min-h-screen p-4 lg:p-8 flex items-center justify-center">
        <div className="glass-card-intense rounded-2xl p-8 text-center">
    ...
    return (
      <div className="relative z-10 min-h-screen p-4 lg:p-8 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-primary mb-2">No Tournaments Found</h2>
          <p className="text-tertiary mb-6">Create a tournament to view match history.</p>
          <Button asChild>
    ...
    <div className="relative z-10 min-h-screen p-4 lg:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6 lg:mb-8">
          {/* Tournament Selector */}
          <div className="glass-card-intense rounded-2xl p-4 lg:p-6 mb-6">
            <div className="flex flex-col lg:flex-row lg:items-center gap-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-green-500/10 dark:bg-green-500/10 rounded-xl flex items-center justify-center flex-shrink-0">
                  <Filter className="h-5 w-5 text-green-600 dark:text-green-400" />
                </div>
                <div>
                  <label className="text-sm font-medium text-primary block mb-1">Select Tournament</label>
                  <p className="text-xs text-tertiary">Choose a tournament to view its matches</p>
                </div>
              </div>
              ...
              <select
                ...
                className="flex-1 px-4 py-3 bg-muted/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500/50 text-primary text-sm lg:text-base"
              >
                {tournaments.map((tournament) => (
                  <option key={tournament._id} value={tournament._id} className="bg-background">
          ...
          {/* View Mode Toggle */}
          <div className="flex items-center gap-2 p-1 glass-card-intense rounded-xl w-full sm:w-auto mb-6">
            <button
              ...
              <div className="flex flex-col lg:flex-row gap-3 lg:gap-4">
                <div className="flex-1">
                  <div className="relative">
                    <Search className="absolute left-3 lg:left-4 top-1/2 transform -translate-y-1/2 h-4 w-4 text-tertiary" />
                    <input
                      type="text"
                      placeholder="Search players..."
                      value={searchTerm}
                      onChange={(e) => setSearchTerm(e.target.value)}
                      className="w-full pl-10 lg:pl-12 pr-4 py-3 bg-muted/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500/50 text-primary placeholder:text-muted-foreground text-sm"
                    />
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  <select
                    ...
                    className="flex-1 lg:flex-none px-3 lg:px-4 py-3 bg-muted/50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500/50 text-primary text-sm"
                  >
        ...
        {isLoadingMatches ? (
          ...
          <div className="glass-card-intense rounded-2xl p-12 text-center">
            <Trophy className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
            <p className="text-tertiary">Select a tournament to view matches</p>
          </div>
        )}
      </div>
    </div>
