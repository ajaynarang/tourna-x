...
export default function PlayerPracticeMatchesPage() {
  return (
    <AuthGuard requiredRoles={['player']}>
      <PlayerPracticeMatchesContent />
    </AuthGuard>
  );
}

function PlayerPracticeMatchesContent() {
  const { user } = useAuth();
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                  router.push('/player/practice-matches/create');
                }}
          ...
          <div className="grid gap-4">
            {matches.map((match) => {
              ...
              return (
                <Link
                  key={match._id}
                  href={`/player/practice-matches/${match._id}`}
